...
from PyQt5.QtWidgets import QApplication, QWidget, QColorDialog, QInputDialog, QAction
...
class LabelMinimumAction(QAction):
...
class ColorCommittorAction(QAction):
...
class LayoutByCommittorAction(QAction):
    """this action will color the graph by committor probabilities"""
    def __init__(self, minimum1, minimum2, parent=None):
...
class DGraphDialog(QMainWindow):
